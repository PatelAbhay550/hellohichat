            ...
            >
              ...
              {msg.audio?.length > 5 && (
                <div className="flex items-center gap-2">
                  ...
                  >
                    {isPlayingAudio &&
                    audioPlayerRef.current?.src === msg.audio ? (
        ...
        <div className="flex items-center gap-2">
          {editingMessageId && (
            <div className="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg px-3 py-2 w-full mb-2">
              ...
              <span className="text-sm italic flex-1 truncate">
                {messages.find((msg) => msg.id === editingMessageId)?.text}
              </span>
              <button
          ...
          <input
            ...
            onKeyDown={(e) =>
              e.key === "Enter" &&
              (editingMessageId ? handleEditMessage() : handleSend())
            }
          />
